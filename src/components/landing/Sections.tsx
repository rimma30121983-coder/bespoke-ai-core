  ...
  return (
    <section className="relative py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          eyebrow="Сравнение"
          title={<>Почему индивидуальная <span className="whitespace-nowrap">AI-система</span><br className="hidden sm:block" /> <span className="gradient-text">лучше шаблонного решения</span></>}
        />
