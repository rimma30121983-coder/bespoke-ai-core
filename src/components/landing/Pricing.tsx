...
const tiers = [
  {
    ...
    desc: "Для понимания структуры будущей системы.",
    result: "Структура системы и техническое задание.",
    badge: { label: "Старт", icon: <Compass className="w-3 h-3" /> },
    features: ["анализ процессов", "карта модулей", "логика ролей"],
    cta: "Обсудить аудит",
    featured: false,
  },
  {
    name: "AI-система под ключ",
    desc: "Для запуска рабочей системы управления.",
    result: "Готовая система под процессы бизнеса.",
    badge: { label: "Оптимальный формат", icon: <Star className="w-3 h-3" /> },
    features: ["проектирование", "разработка", "дашборды и роли"],
    cta: "Заказать систему",
    featured: true,
  },
  {
    name: "AI-система + автоматизация",
    desc: "Для внедрения AI-аналитики и сценариев.",
    result: "Система с рекомендациями и автоматизацией.",
    badge: { label: "AI-powered", icon: <Sparkles className="w-3 h-3" /> },
    features: ["AI-анализ", "рекомендации", "сценарии автоматизации"],
