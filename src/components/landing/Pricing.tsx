...
const tiers = [
  ...
  },
  {
    ...
    features: ["всё из разработки AI-системы", "AI-анализ данных", "AI-ассистент", "рекомендации", "автоматические выводы", "интеллектуальные сценарии", "расширенная аналитика"],
