...
const tiers = [
  {
    ...
    desc: "Понять структуру будущей системы до разработки.",
  ...
  },
  {
    ...
    desc: "Готовая рабочая система управления бизнесом.",
    result: "Рабочая система управления бизнесом.",
    badge: { label: "Оптимальный формат", icon: <Star className="w-3 h-3" /> },
    features: ["проектирование", "разработка", "дашборды", "роли", "аналитика"],
    cta: "Заказать систему",
    featured: true,
  },
  {
    name: "AI-система + автоматизация",
    desc: "Система с AI-анализом, рекомендациями и автоматизацией.",
    result: "Система с AI-анализом, рекомендациями и автоматизацией.",
    badge: { label: "AI-powered", icon: <Sparkles className="w-3 h-3" /> },
    features: ["AI-анализ", "рекомендации", "сценарии автоматизации", "расширенная аналитика"],
