...
const faqs = [
  { q: "Вы работаете только с определёнными сферами?", a: "Нет. Мы проектируем систему под процессы конкретного бизнеса и работаем с разными нишами." },
  { q: "Можно ли сделать систему под наши текущие процессы?", a: "Да. Берём вашу текущую логику, улучшаем её и переносим в полноценную AI-систему." },
  { q: "Можно ли добавить AI-анализ и рекомендации?", a: "Да. AI встраивается в аналитику, задачи, продажи и помощь руководителю." },
  { q: "Можно ли дорабатывать систему после запуска?", a: "Да. Система развивается вместе с бизнесом — добавляем модули и сценарии." },
  { q: "С чего начинается работа?", a: "С аудита: изучаем процессы, цели и задачи, после чего предлагаем структуру будущей системы." },
];
