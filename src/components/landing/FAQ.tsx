...
const faqs = [
  { q: "Вы делаете CRM только для одной сферы?", a: "Нет. Мы проектируем систему под процессы конкретного бизнеса, поэтому можем работать с разными нишами." },
  { q: "Можно ли сделать систему похожую на нашу текущую таблицу или CRM?", a: "Да. Мы можем взять вашу текущую структуру, улучшить её и перенести в полноценную систему." },
  ...
  { q: "Это будет шаблонная CRM?", a: "Нет. Система создаётся индивидуально под вашу бизнес-логику." },
